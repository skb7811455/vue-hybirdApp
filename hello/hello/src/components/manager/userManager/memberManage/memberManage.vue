<template>
    ...
    <ul>
      <li v-for="(member,index) in members" @touchend="touchEnd(index)">
        <div class="user-box" @touchstart="startTouch()">  
          ...
          <div class="hide-box" ref="hidebox" style="right:-195px">
            <div class="pop-text remind" ref="popbox"><span class="text">提醒</span></div>
            <div class="pop-text warn" ref="popbox2"><span class="text">警告</span></div>         
